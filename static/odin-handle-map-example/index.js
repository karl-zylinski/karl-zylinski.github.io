...
var ASM_CONSTS = {
  123736: () => { if (document.fullscreenElement) return 1; },  
 123782: () => { return document.getElementById('canvas').width; },  
 123834: () => { return parseInt(document.getElementById('canvas').style.width); },  
 123902: () => { document.exitFullscreen(); },  
 123929: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 124002: () => { if (document.fullscreenElement) return 1; },  
 124048: () => { return document.getElementById('canvas').width; },  
 124100: () => { return screen.width; },  
 124125: () => { document.exitFullscreen(); },  
 124152: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 124285: () => { return window.innerWidth; },  
 124311: () => { return window.innerHeight; },  
 124338: () => { if (document.fullscreenElement) return 1; },  
 124384: () => { return document.getElementById('canvas').width; },  
 124436: () => { return parseInt(document.getElementById('canvas').style.width); },  
 124504: () => { if (document.fullscreenElement) return 1; },  
 124550: () => { return document.getElementById('canvas').width; },  
 124602: () => { return screen.width; },  
 124627: () => { return window.innerWidth; },  
 124653: () => { return window.innerHeight; },  
 124680: () => { if (document.fullscreenElement) return 1; },  
 124726: () => { return document.getElementById('canvas').width; },  
 124778: () => { return screen.width; },  
 124803: () => { document.exitFullscreen(); },  
 124830: () => { if (document.fullscreenElement) return 1; },  
 124876: () => { return document.getElementById('canvas').width; },  
 124928: () => { return parseInt(document.getElementById('canvas').style.width); },  
 124996: () => { document.exitFullscreen(); },  
 125023: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 125081: () => { return screen.width; },  
 125106: () => { return screen.height; },  
 125132: () => { return window.screenX; },  
 125159: () => { return window.screenY; },  
 125186: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 125239: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 125310: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 125367: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 125623: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 125694: () => { if (document.fullscreenElement) return 1; },  
 125740: () => { return window.innerWidth; },  
 125766: () => { return window.innerHeight; },  
 125793: () => { if (document.pointerLockElement) return 1; }
};

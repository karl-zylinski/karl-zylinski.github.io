...
var ASM_CONSTS = {
  123608: () => { if (document.fullscreenElement) return 1; },  
 123654: () => { return document.getElementById('canvas').width; },  
 123706: () => { return parseInt(document.getElementById('canvas').style.width); },  
 123774: () => { document.exitFullscreen(); },  
 123801: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 123874: () => { if (document.fullscreenElement) return 1; },  
 123920: () => { return document.getElementById('canvas').width; },  
 123972: () => { return screen.width; },  
 123997: () => { document.exitFullscreen(); },  
 124024: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 124157: () => { return window.innerWidth; },  
 124183: () => { return window.innerHeight; },  
 124210: () => { if (document.fullscreenElement) return 1; },  
 124256: () => { return document.getElementById('canvas').width; },  
 124308: () => { return parseInt(document.getElementById('canvas').style.width); },  
 124376: () => { if (document.fullscreenElement) return 1; },  
 124422: () => { return document.getElementById('canvas').width; },  
 124474: () => { return screen.width; },  
 124499: () => { return window.innerWidth; },  
 124525: () => { return window.innerHeight; },  
 124552: () => { if (document.fullscreenElement) return 1; },  
 124598: () => { return document.getElementById('canvas').width; },  
 124650: () => { return screen.width; },  
 124675: () => { document.exitFullscreen(); },  
 124702: () => { if (document.fullscreenElement) return 1; },  
 124748: () => { return document.getElementById('canvas').width; },  
 124800: () => { return parseInt(document.getElementById('canvas').style.width); },  
 124868: () => { document.exitFullscreen(); },  
 124895: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 124953: () => { return screen.width; },  
 124978: () => { return screen.height; },  
 125004: () => { return window.screenX; },  
 125031: () => { return window.screenY; },  
 125058: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 125111: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 125182: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 125239: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 125495: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 125566: () => { if (document.fullscreenElement) return 1; },  
 125612: () => { return window.innerWidth; },  
 125638: () => { return window.innerHeight; },  
 125665: () => { if (document.pointerLockElement) return 1; }
};

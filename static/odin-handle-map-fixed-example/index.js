...
var ASM_CONSTS = {
  122408: () => { if (document.fullscreenElement) return 1; },  
 122454: () => { return document.getElementById('canvas').width; },  
 122506: () => { return parseInt(document.getElementById('canvas').style.width); },  
 122574: () => { document.exitFullscreen(); },  
 122601: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 122674: () => { if (document.fullscreenElement) return 1; },  
 122720: () => { return document.getElementById('canvas').width; },  
 122772: () => { return screen.width; },  
 122797: () => { document.exitFullscreen(); },  
 122824: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 122957: () => { return window.innerWidth; },  
 122983: () => { return window.innerHeight; },  
 123010: () => { if (document.fullscreenElement) return 1; },  
 123056: () => { return document.getElementById('canvas').width; },  
 123108: () => { return parseInt(document.getElementById('canvas').style.width); },  
 123176: () => { if (document.fullscreenElement) return 1; },  
 123222: () => { return document.getElementById('canvas').width; },  
 123274: () => { return screen.width; },  
 123299: () => { return window.innerWidth; },  
 123325: () => { return window.innerHeight; },  
 123352: () => { if (document.fullscreenElement) return 1; },  
 123398: () => { return document.getElementById('canvas').width; },  
 123450: () => { return screen.width; },  
 123475: () => { document.exitFullscreen(); },  
 123502: () => { if (document.fullscreenElement) return 1; },  
 123548: () => { return document.getElementById('canvas').width; },  
 123600: () => { return parseInt(document.getElementById('canvas').style.width); },  
 123668: () => { document.exitFullscreen(); },  
 123695: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 123753: () => { return screen.width; },  
 123778: () => { return screen.height; },  
 123804: () => { return window.screenX; },  
 123831: () => { return window.screenY; },  
 123858: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 123911: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 123982: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 124039: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 124295: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 124366: () => { if (document.fullscreenElement) return 1; },  
 124412: () => { return window.innerWidth; },  
 124438: () => { return window.innerHeight; },  
 124465: () => { if (document.pointerLockElement) return 1; }
};
